		...
		<?php if($_GET['o'] == 'add') { 
  		...
  		<form class="form-horizontal" method="POST" action="php_action/createOrder.php" id="createOrderForm">
			  ...
			  <div class="form-group">
                ...
                <div class="form-group">
                    <label for="brandStatus" class="col-sm-2 control-label">Package Name: </label>
                    <div class="col-sm-5">
                        <select class="form-control" id="standardPackages" name="standardPackages" onchange="">
                            <option value="">~~SELECT~~</option>
                            <?php
                                $standardPackagesSql = "SELECT * FROM standard_packages WHERE active = 1 AND status = 1";
                                $standardPackagesData = $connect->query($standardPackagesSql);
                                while($row = $standardPackagesData->fetch_array()) {
			  ...
			  <div class="col-md-6">
				  ...
				  <div class="form-group">
				    <label for="vat" class="col-sm-3 control-label">GST 18%</label>
				    <div class="col-sm-9">
